...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (javax.vecmath.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new javax.vecmath.Matrix4f(new javax.vecmath.Matrix4f());
    }
